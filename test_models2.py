...
with app.app_context():
    ...
    a = AdminUser.query.filter_by(username='testadmin_model2').first()
    if not a:
        a = AdminUser(username='testadmin_model2'); a.set_password('secret'); db.session.add(a); db.session.commit()
